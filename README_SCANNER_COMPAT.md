# Scanner Suivi → ASIN → M110 — V40.3.6 + VINE Tracking V3.3.7.7
...
- exige le build Apps Script **3.3.7.7** ;
...
- Service Worker `vine-m110-v40.3.6`, appels Apps Script/API/externe en réseau pur ;
