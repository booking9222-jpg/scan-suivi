# Scanner Suivi → ASIN → M110 — V40.3.8 + VINE Tracking V3.3.7.9
...
- exige le build Apps Script **3.3.7.9** ;
...
- Service Worker `vine-m110-v40.3.8`, appels Apps Script/API/externe en réseau pur ;
- profils M110, caméra, impression, formats, catalogue et correctif 40×20 / marge droite 1,5 mm conservés.


V40.3.8 ne change pas le moteur d'impression/recherche M110 : seul le contrôle de compatibilité exige désormais le serveur V3.3.7.9.
