# Scanner Suivi → ASIN → M110 — V40.3.4 + VINE Tracking V3.3.7.5
...
- exige le build Apps Script **3.3.7.5** ;
...
- Service Worker `vine-m110-v40.3.4`, appels Apps Script/API/externe en réseau pur ;
